...
export const Section = ({ data, index, scrollProgress, setLocked }) => {
    ...
    const renderLayout = () => {
        switch (data.layout) {
            case 'gallery': return <GalleryLayout items={data.items} setActiveItem={setActiveItem} />;
            case 'portal': return <PortalLayout items={data.items} setActiveItem={setActiveItem} />;
            case 'slabs': return <SlabLayout items={data.items} setActiveItem={setActiveItem} />;
            case 'timeline': return <TimelineLayout items={data.items} setActiveItem={setActiveItem} />;
            default: return null;
        }
    };
    ...
    return (
        ...
        >
            ...
            <FocusPanel key="panel" item={activeItem} onClose={() => setActiveItem(null)} />
