...
export const TimelineLayout = ({ items }) => {
  ...
  const getGridStyle = (index) => {
    switch (index) {
      ...
      case 1:
        return { gridColumn: "3", gridRow: "1" }; // Top Right
      case 2:
        return {
          gridColumn: "2",
          gridRow: "2",
      ...
      case 3:
        return { gridColumn: "1", gridRow: "3" }; // Bottom Left
      case 4:
        return { gridColumn: "3", gridRow: "3" }; // Bottom Right
      default:
        return {};
    }
  };
        ...
        {items.map((item, index) => (
          <motion.div
            ...
            style={{
              ...getGridStyle(index),
              backgroundColor:
                hoveredItem && hoveredItem.id !== item.id ? "#111" : "#222",
              border:
          ...
          >
            ...
            <div style={{ marginTop: "8px", opacity: 0.5, fontSize: "0.8rem" }}>
              +
            </div>
          </motion.div>
        ))}
              ...
              >
                ...
                >
                  ...
                  <div
                    style={{
                      ...
                      inset: 0,
                      background:
                        "linear-gradient(to top, #1a1a1a, transparent 20%)",
                    }}
                  />
                </div>
                ...
                >
                  ...
                  {hoveredItem.challenge && (
                    ...
                    >
                      <span style={{ color: "#ff9800", fontSize: "1.3rem" }}>
                        ⚠
                      </span>
                      <div>
                        <strong
